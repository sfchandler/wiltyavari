        ...
        <div class="error"></div>
            <form name="frmBnkAcc" id="frmBnkAcc" class="smart-form" method="post">
                <div class="row">
                    <section class="col col-4">
                        <label for="companyId" class="input">Company Name:
            ...
            <div>
                <table class="table table-bordered">
                    <thead><tr><th>Account Name</th><th>Company Name</th><th>Account Number</th><th>BSB</th><th>User Name</th><th>User Code</th><th>Trade Code</th><th>Action</th></tr></thead>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function getCorporateBankAccounts(){
            ...
            $.ajax({
                type:"GET",
                url: "./saveCompanyBankAccount.php",
                data:{action:action},
                dataType: 'html',
        ...
        $(document).on('click','.saveBankAccBtn', function (e) {
            ...
            var frmBnkAcc = $("#frmBnkAcc").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "./saveCompanyBankAccount.php",
                        data: {accountName:accountName,accountNumber:accountNumber,bsb:bsb,userName:userName,userCode:userCode,tradeCode:tradeCode,accId:accId,companyId:companyId,action:action},
                        dataType: "html",
                        success: function (data) {
