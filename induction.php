...
}elseif(validateInductionDocumentSigned($mysqli,$_REQUEST['candidateId'])){
    $msg = "Induction Signed submitted";
    header("Location:error.php?error=$msg");
}
?>
<!doctype html>
...
<table class="table" width="980px">
    <tbody>
      ...
      <tr>
        <td>
            <ul>
                <li>Our best available contact number is <span style="font-size: 16px; color: #2a6395; font-weight: bold">03 96 56 9777. We are a 24-Hour Service.</span> The number that appears on your mobile when we call you is <span style="font-size: 16px; color: #2a6395; font-weight: bold">03 9656 9777.</span></li>
                ...
                <li><b>IF YOU ARE SICK – Please call us. <span style="font-size: 16px; color: #2a6395; font-weight: bold">DO NOT TEXT IN SICK</span>. You are required to communicate with a consultant directly if you are unable to attend work. We do not accept Text Messages or Emails if you are sick or cancelling a shift.</b></li>
                <li>You are required to provide us with <span style="color: red; font-weight: bold">minimum 4 hours' notice</span> if you are not able to attend an allocated shift for any reason. Failure to do so may result in your account being made <span style="font-size: 16px; color: #2a6395; font-weight: bold">INACTIVE.</span></li>
      ...
      <tr>
          <td>
              <ul>
                  ...
                  Please refer to the mobile app user guide for instructions on how to clock in and out using the app.
      ...
      <tr>
          <td><b>IN ALL CASES YOU ARE REQUIRED TO CLOCK IN AND OUT USING THE  <?php echo DOMAIN_NAME; ?> MEMBER APP</b></td>
      </tr>
      <tr>
      ...
      <tr>
          <td>
              <p style="text-align: justify">
                  As mentioned earlier, you need to use  <?php echo DOMAIN_NAME; ?> Mobile app to Accept shifts and Clock in and out. The app user guide will be emailed to you once you joined with  <?php echo DOMAIN_NAME; ?>.
              </p>
              <p style="text-align: justify">
                  You MUST read the user guide. If you have any question regarding any functionality of the mobile app or if you have not received the user guide, please call  <?php echo DOMAIN_NAME; ?> on <span style="font-size: 14px; color: #2a6395; font-weight: bold">03 9656 9777.</span>
              </p>
          </td>
      </tr>
      <tr>
      ...
      <tr>
          <td>
              <div style="width: 500px;">
                  <form name="frmInductionForm" id="frmInductionForm" method="post">
                      <p>I HAVE READ AND UNDERSTOOD THE ABOVE INDUCTION.</p>
                      <br>
                      <label>Candidate Signature</label>
                      <div id="signature"></div>
                      <br>
                      <input type="hidden" name="canId" id="canId" value="<?php echo base64_decode(urldecode($_REQUEST['candidateId'])); ?>">
                      <input type="hidden" name="conEmail" id="conEmail" value="<?php echo base64_decode(urldecode($_REQUEST['conEmail'])); ?>">
...
<script type="text/javascript" src="js/inductionScript.js"></script>
