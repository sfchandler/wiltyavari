...
$checkedInCasuals = getCheckedInCasualsAllDateRange($mysqli,$startDate,$endDate);
$rosteredCasuals = getRosteredConfirmedCasualsAllDateRange($mysqli,$startDate,$endDate);
$mailBody = '';
$html='';
$htmlRoster = '';
...
try {
    generateMailNotification('TimeClock Notification - Check IN validation','swarnajithf@chandlerservices.com.au', 'virana@chandlerpersonnel.com.au', $mailBody);
}catch (Exception $e){
    $e->getMessage();
}