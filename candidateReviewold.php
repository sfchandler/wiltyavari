  ...
  header("Location:login.php?error_msg=$msg");
	...
	$stmt = $mysqli->prepare("SELECT DISTINCT
		  ...
		  WHERE
			...
			candidate.sex,
			candidate.suburb,
			candidate.currentWrk,
			candidate.howfar,
			candidate.criminalConviction,
			candidate.convictionDescription,
			candidate.residentStatus,
			candidate.genLabourPay,
			candidate.hasCar,
			candidate.medicalCondition,
			candidate.medicalConditionDesc,
			candidate.workType,
			candidate.overtime,
			candidate.status
			*/
			...
			$stmt->execute();
			$stmt->bind_result($firstName,$lastName,$address,$homePhoneNo,$mobileNo,$email,$consultantId,$messageid,$candidateId,$screenDate);
			$stmt->store_result();
...
<html lang="en-us">
	...
	<body>
		...
		<header id="header">
			<div id="logo-group">
				<span id="logo"> <img src="img/logo.png" alt=" Admin"> </span>
                                    	...
                                    	<form class="smart-form" name="frmUpload" id="frmUpload" action="processUpload.php" method="post">
                                            <div class="row">
                                                ...
                                                <label for="ph" class="label">Phone Number</label>
                                                    ...
                                                    <button name="uploadBtn" type="submit" class="uploadBtn btn btn-primary btn-sm"><i class="glyphicon glyphicon-upload"></i> Upload</button>
                                                 </section>
                                             </div>       
                                    	</form>
                                    </div>
                                    ...
                                    <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                      <thead>	
                                        ...
                                        <?php 
                                            ...
                                            ?>
                                            <tr>
                                                <td id="matchPercentage"><input id="pm" value="<?php echo $matchPercentage; ?>" type="hidden">
                                                <?php echo $matchPercentage; ?>
                                                </td>
                                                <td><?php echo $candidateId; ?></td>
                                                <td class="msgId" data-messageid="<?php echo $messageId; ?>" fname="<?php echo $firstName; ?>" lname="<?php echo $lastName;?>" canId="<?php echo $candidateId; ?>" eml="<?php echo $email; ?>" mbl="<?php echo $mobileNo; ?>"><a href="candidateMain.php?messageid=<?php echo $messageId; ?>&canId=<?php echo $candidateId; ?>&fname=<?php echo $firstName; ?>&lname=<?php echo $lastName;?>&eml=<?php echo $email; ?>&mbl=<?php echo $mobileNo; ?>" target="_blank"><?php echo $firstName.' '.$lastName; ?></a></td>
		...
		<div class="page-footer">
			<div class="row">
				<div class="col-xs-12 col-sm-6">
					<span class="txt-color-white"> <span class="hidden-xs"> -  Employee Recruitment System</span> © <?php echo date('Y'); ?></span>
				</div>
