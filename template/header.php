<meta charset="utf-8">
        ...
        <link rel="stylesheet" type="text/css" href="js/chosen_v1.8.7/chosen.min.css">
        <link rel="stylesheet" type="text/css" href="css/bootstrap-treeview/bootstrap-treeview.css">