<nav>
				<ul>
                    ...
                    <li class="active">
                        ...
                        <?php if (!in_array($consultant_id, array(105,112))) { ?>
                        <ul>
                            <li class="active">
                    ...
                    <?php if($_SESSION['userType']=='ACCOUNTS' || $_SESSION['userType']=='ADMIN') { ?>
                            ...
                            <ul>
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        ...
                                        <!--
                                        <li class="active">
                                            <a href="payReversal.php">Pay Reversal</a>
                                        </li>
                                        -->
                                    </ul>
                                </li>
                                <li class="active">
                                    <a href="#"><i class="fa fa-lg fa-fw fa-file"></i> <span>TimeClock Check</span> <span class="badge pull-right inbox-badge margin-right-13"></span></a>
                                    <ul>
                                        <li class="active">
                                            <a href="payroll_clockin_check.php">Payroll ClockIN ClockOut Check</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="active">
                                    ...
                                    <ul>
                                        ...
                                        <li class="active">
                                            <a href="timesheetCheck.php">TimeSheet Check</a>
                                        </li>
                                        <li class="active">
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        ...
                                        <!--<li class="active">
                                            <a href="singletouch.php">Single Touch CSV</a>
                                        </li>-->
                                    </ul>
                                </li>
                                <!--<li class="active">
                        ...
                        <li class="active">
                            ...
                            <ul>
                                <!--<li class="active">
                                    <a href="invoiceCreation.php">Bulk Invoice Creation</a>
                                </li>
                                <li class="active">
                                    <a href="clientInvoiceCreation.php">Client Based Invoice Creation</a>
                                </li>-->
                                <li class="active">
