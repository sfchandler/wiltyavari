...
<html lang="en-us">
	...
	<body style="background: white">
		...
		<div id="main" role="main">
			...
			<div id="container">
                <ul id="inboxTab" class="nav nav-tabs">
                    <li>
                        <a href="#mlb" data-toggle="tab"><b><i class="fa fa-fw fa-lg fa-inbox"></i>SEEK (<span class="numRows"><?php echo getInboxMessageCount($mysqli,$_SESSION['accountName']); ?></span>)</b></a>
                    </li>
                    <!--<li>
                    ...
                    <div class="tab-pane fade in active" id="mlb">
                            <div class="table-wrap custom-scroll animated fast fadeInRight">
                                <div id="rowInbox">
                                    ...
                                    <table id="tblMail" class="table table-borderless">
                                        <thead id="tblHead">
                                          <tr>
		...
		<!-- END PAGE FOOTER -->
		<?php include "./template/inbox_scripts.php"; ?>
        <?php 
