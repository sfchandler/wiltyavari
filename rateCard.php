                ...
                <div id="left" style="float:left; width: 33%;">
                    <div class="row">
                        <section class="col col-5">
                            ...
                            <select name="deptId" id="deptId"  class="form-control" style=" cursor: pointer; width: 100%">
                            </select><i></i>
                        </section>
                        ...
                        <section class="col col-12">
                            <div id="rateCardDiv">
                                ...
                                <table id="rateCardTable" border="1" cellpadding="2" cellspacing="2" class="table table-striped table-bordered table-hover" width="100%">
                                    <thead>
                                    <tr>
                                        <th><i class="fa fa-fw fa-indent txt-color-blue hidden-md hidden-sm hidden-xs"></i>Pay Category <button id="copyRatesBtn" class="btn btn-sm btn-info">Copy Rates</button></th>
                                        <th><i class="fa fa-fw fa-dollar txt-color-blue hidden-md hidden-sm hidden-xs"></i>Pay Rate</th>
                                        <th><i class="fa fa-fw fa-dollar txt-color-blue hidden-md hidden-sm hidden-xs"></i>New Pay Rate</th>
                                        <th><i class="fa fa-fw fa-dollar txt-color-blue hidden-md hidden-sm hidden-xs"></i>Charge Rate</th>
                                        <th><i class="fa fa-fw fa-dollar txt-color-blue hidden-md hidden-sm hidden-xs"></i>New Charge Rate</th>
                                    </tr>
                                    </thead>
