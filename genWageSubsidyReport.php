...
$attributeId = 181;
$wageData = getWageSubsidyData($mysqli,$startWkDate,$endWkDate,$attributeId);
...
$objPHPExcel->getActiveSheet()->getStyle('AO2:AZ2')->applyFromArray($headerBackgroundArray);
...
$time = time();
$filePath = './reports/wageSubsidyReport-'.$time.'.xlsx';
