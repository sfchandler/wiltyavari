    ...
    <div id="content" class="container-body" style="margin-bottom: 50px;">
        ...
        <div class="selectPanel">
            ...
            <div class="row">
                ...
                <section class="col col-4">
                    <label for="generateJotCasualBtn">
                        <button name="generateJotCasualBtn" id="generateJotCasualBtn" class="generateJotCasualBtn btn btn-info btn-sm"><i class="glyphicon glyphicon fa fa-file-pdf-o"></i>&nbsp;&nbsp; Registered Casuals Report</button>
                    </label>
                </section>
            </div>
            </fieldset>
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click', '.generateJotCasualBtn', function () {
            $.ajax({
                url :"genRegisteredCasuals.php",
                type:"POST",
                dataType:"text",
                success: function(data) {
                    console.log('data'+data);
