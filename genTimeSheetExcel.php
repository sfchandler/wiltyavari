...
<table><thead><tr><th>Employee ID :</th><th>'.$candidateId.'</th><th>Employee Name: </th><th>'.getCandidateFirstNameByCandidateId($mysqli,$candidateId).' '.getCandidateLastNameByCandidateId($mysqli,$candidateId).'</th></tr></thead></table>
...
$htmlfile = __DIR__.'/timesheet/' . $htmlFile; // create new html file under temp folder
file_put_contents($htmlfile, utf8_decode($html)); // copy the html contents into tmp created html file

$objReader = new PHPExcel_Reader_HTML; // new loader
$objPHPExcel = $objReader->load($htmlfile);

$objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel2007');
$objWriter->save('./timesheet/'.$fileNameExcel);
echo './timesheet/'.$fileNameExcel;
?>