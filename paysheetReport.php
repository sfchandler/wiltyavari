...
<div id="main" role="main">
    ...
    <div id="content" class="container-body" style="margin-bottom: 50px;">
        <h2>Paysheet Report </h2>
        <div class="error"></div>
        <div class="selectPanel">
            <fieldset class="smart-form">
            <div class="row">
                <section class="col col-3">
                    <label for="clientId" class="select">Select Client for client based report</label>
            ...
            <div class="row">
                ...
                <section class="col col-3">
                    <label for="rateYear" class="input">
                        <input type="text" name="rateYear" id="rateYear" value="" class="pull-left" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc;" placeholder="Rate Year"/>
                    </label>
                </section>
            </div>
            <div class="row">
                <section class="col col-6">
                    ...
                    <br><br>
                    <label for="genBtn">
                        <button name="genBtn" id="genBtn" class="genBtn btn btn-info btn-sm"><i class="glyphicon glyphicon fa fa-file-pdf-o"></i>&nbsp;&nbsp;Workhours Report</button>
                    </label>
                </section>
            </div>
            </fieldset>
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click','.generateBtn',function () {
            ...
            var action = 'CLIENT';
            $.ajax({
                url :"genPaysheetReport.php",
                type:"POST",
                data:{startWkDate:startWkDate,endWkDate:endWkDate,rateYear:rateYear,clientId:clientId,empId:empId,action:action},
                dataType:"html",
                success: function(data) {
        ...
        $(document).on('click','.genBtn',function () {
            ...
            $.ajax({
                url :"genPaysheetReport.php",
                type:"POST",
                data:{startWkDate:startWkDate,endWkDate:endWkDate,clientId:clientId,action:action},
                dataType:"html",
                success: function(data) {
                    /*$('.reportDisplay').html('');
                    $('.reportDisplay').html(data);*/
