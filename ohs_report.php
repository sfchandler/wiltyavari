...
<div id="main" role="main">
    ...
    <div id="content" class="container-body" style="margin-bottom: 50px;">
        <h2><i class="fa fa-lg fa-fw fa-clock-o"></i>OH&S Report</h2>
        <div class="error"></div>
        <div class="selectPanel">
            <fieldset class="smart-form">
                <div class="row">
                    ...
                    <section class="col col-3">
                        <label for="endDate" class="input">
                            <select name="ohs_all" id="ohs_all" class="form-control">
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click','.generateBtn',function(){
            ...
            var ohs_all = $('#ohs_all :selected').val();
            if(startDate!='' && endDate != '') {
                $.ajax({
                    url: "genOHSReport.php",
                    type: "POST",
                    dataType: "text",
                    data: {startDate: startDate, endDate: endDate,clientId:clientId,ohs_all:ohs_all},
                    success: function (data) {
