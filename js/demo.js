...
$('#smart-topmenu')
    .on('change', function (e) {
        if ($(this)
			...
			/* reloading to left side menu  ---------------------------------------- EDITED --------------------------*/
