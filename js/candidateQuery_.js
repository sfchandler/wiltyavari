...
$(function() {
	...
	$(document).on('click', '.empContractBtn', function(e) {
		...
		var mailbody = 'Please sign the employment contract to fulfill your recruitment by clicking, <a href="https://www.demo.outapay.com.au/empTerms.php?conEmail='+conEmail+'&firstName='+firstName+'&lastName='+lastName+'&candidateId='+candidateId+'&email='+email+'" target="_blank">Click here to submit Employment Contract</a>';
	...
	$(document).on('click', '.inductionBtn', function(e) {
		...
		var mailbody = 'Please sign the induction to fulfill your recruitment by clicking, <a href="https://www.demo.outapay.com.au/induction.php?conEmail='+encodeURIComponent(window.btoa(conEmail))+'&candidateId='+encodeURIComponent(window.btoa(candidateId))+'" target="_blank">Click here to submit Induction</a>';
	...
	$(document).on('click', '.covidBtn', function(e) {
		...
		var candidateId = $('#canId').val();
		var mailbody = 'Please sign the  COVID19 Policy to fulfill your recruitment by clicking, <a href="https://www.demo.outapay.com.au/covid19.php?conEmail='+conEmail+'&candidateId='+candidateId+'" target="_blank">Click here to submit COVID19 Policy</a>';
	...
	$(document).on('click', '.jotFormBtn', function(e) {
		...
		var mailbody = 'Hi  '+fullName+', \n<br><br>' +
			...
			'              <tr>\n' +
			'                  <td style="border-radius: 2px;" bgcolor="#3377b1"><a href="https://www.demo.outapay.com.au/jotForm.php?conEmail='+conEmail+
			'&empId='+empId+
			'&empEmail='+empEmail+
			...
			'&emp_address='+address+
			'" target="_blank" style="padding: 8px 12px; border: 1px solid #3377b1;border-radius: 2px;font-family: Helvetica, Arial, sans-serif;font-size: 14px; color: #ffffff;text-decoration: none;font-weight:bold;display: inline-block;">Click here to submit Registraion form</a></td>\n' +
			'              </tr>\n' +
			'          </table>\n' +
			'      </td>\n' +
			'  </tr>\n' +
	...
	$(document).on('click', '.formsBtn', function(e) {
		...
		var mailbody = ' Please fill the forms required and submit online, in-order to fulfill your recruitment by clicking, <a href="https://www.demo.outapay.com.au/forms.php?conEmail='+conEmail+'&empId='+empId+'&empEmail='+empEmail+'" target="_blank">Click here to submit forms</a>';
	...
	$(document).on('click', '.refFormBtn', function(e) {
		...
		var mailbody = 'Hi  '+refFormFullName+', \n<br><br>'+
			...
			'          <table cellspacing="0" cellpadding="0">\n' +
			'              <tr>\n' +
			'                  <td style="border-radius: 2px;" bgcolor="#3377b1"><a href="https://www.demo.outapay.com.au/referenceCheck.php?conEmail='+conEmail+'&id='+empId+'&refEmail='+refEmail+'&refName='+refFormFullName+'" target="_blank" style="padding: 8px 12px; border: 1px solid #3377b1;border-radius: 2px;font-family: Helvetica, Arial, sans-serif;font-size: 14px; color: #ffffff;text-decoration: none;font-weight:bold;display: inline-block;">Click here to submit Reference Check form</a></td>\n' +
			'              </tr>\n' +
			'          </table>\n' +
			'      </td>\n' +
			'  </tr>\n' +
	...
	$(document).on('click', '.surveyBtn', function(e) {
		...
		var mailbody = 'Hi  '+surveyFormFullName+', \n<br><br>'+
			...
			'          <table cellspacing="0" cellpadding="0">\n' +
			'              <tr>\n' +
			'                  <td style="border-radius: 2px;" bgcolor="#3377b1"><a href="https://www.demo.outapay.com.au/customerSurvey.php?cons_id='+cons_id+'&id='+candidateId+'&surveyCanEmail='+surveyCanEmail+'&surveyName='+surveyFormFullName+'" target="_blank" style="padding: 8px 12px; border: 1px solid #3377b1;border-radius: 2px;font-family: Helvetica, Arial, sans-serif;font-size: 14px; color: #ffffff;text-decoration: none;font-weight:bold;display: inline-block;">Click here to submit Customer Satisfaction Survey</a></td>\n' +
			'              </tr>\n' +
			'          </table>\n' +
			'      </td>\n' +
			'  </tr>\n' +
	...
	$(document).on('click', '.empHandbookBtn', function(e) {
		...
		var mailbody = 'Please sign and submit the Employee Handbook to fulfill your recruitment by clicking, <a href="https://www.demo.outapay.com.au/empHandbook.php?conEmail='+conEmail+'&candidateId='+candidateId+'" target="_blank">Click here to Sign and Submit Handbook</a>';
