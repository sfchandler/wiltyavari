<nav>
		    ...
		    <!--<li class="active">
                        <a href="calendar.php"><i class="fa fa-lg fa-fw fa-calendar"></i> <span>Appointments Calendar</span> <span class="badge pull-right inbox-badge margin-right-13"></span></a>
                    </li>-->
