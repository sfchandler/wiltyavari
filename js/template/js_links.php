        ...
        <script src="js/jquery-mousewheel/3.1.13/jquery.mousewheel.js"></script>
        <script src="js/globalize/0.1.1/globalize.js"></script>
        <script src="js/globalize/0.1.1/globalize.culture.de-DE.js"></script>
