        ...
        <div class="filterPanel">
            ...
            <div class="pull-left">
                <label for="generateBtn">
                    <button name="genExcelOpenBtn" id="genExcelOpenBtn" class="genExcelOpenBtn btn btn-primary btn-square btn-sm"><i class="glyphicon glyphicon-export"></i>&nbsp;Generate Report</button>
                </label>
            </div>
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click', '.genExcelOpenBtn', function(){
            var startDate = $('#startDate').val();
            var endDate = $('#endDate').val();
            var status = $('#shiftStatus :selected').val();
                $.ajax({
                    url: "genRosterOpenShifts.php",
                    type: "POST",
                    dataType: "text",
