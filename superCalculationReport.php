...
<div id="main" role="main">
    ...
    <div id="content" class="container-body" style="margin-bottom: 50px;">
        <h2>Super Calculation Report</h2>
        <div class="error"></div>
            ...
            <div class="row">
                <section class="col col-3">
                    <label for="limit" class="input">Threshold(e.g. 450)
                        <input type="text" name="limit" id="limit" value="450" class="pull-left" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 100%" placeholder="limit" />
                    </label>
                </section>
            </div>
            <div class="row">
        ...
        $(document).on('click','.generateBtn',function(){
            ...
            if(startDate!='' && endDate != '' && limit !='') {
                $.ajax({
                    ...
                    type: "POST",
                    dataType: "html",
                    data: {startDate: startDate, endDate: endDate, limit: limit},
