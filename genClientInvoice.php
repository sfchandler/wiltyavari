...
if(!checkInvoiceGeneration($mysqli,$weekendingDate)) {
    ...
    $invData = getInvoiceTimeSheetTotalsByClient($mysqli, $weekendingDate, $payrollName, $jobCode,$clientId);
    if (!empty($invData) || ($invData != '')) {
        ...
        saveInvoicePathByClient($mysqli,$weekendingDate,$clientCode,$downloadPath,$fileName.'.pdf',$invDate);
        echo './invoice/'.$clientCode.'/'. $fileName . '.pdf';
    } else {
        echo $invData;
    }
}else{
