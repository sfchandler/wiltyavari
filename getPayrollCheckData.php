...
$timesheetStatus = $_REQUEST['timesheetStatus'];
switch ($action) {
    case 'GET':
        if(isset($clientid)) {
            echo getPayrollCheckData($mysqli,$clientid,$positionid,$deptid,$startDate,$endDate,$candidateId,$loggedInUserType,$timesheetStatus);
        }else{
    ...
    case 'EXCEL':
        try{
            if(!empty($clientid)) {
                $payrollCheckData = genPayrollCheckExcel($mysqli,$clientid,$positionid,$deptid,$startDate,$endDate,$candidateId,$timesheetStatus);
